...
- `metamap-client-server-redesign-plan.md`: plan de reescritura de Notificaciones MetaMap hacia una arquitectura cliente/servidor con cola durable y tunel bancario
