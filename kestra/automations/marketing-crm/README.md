...
- La creacion de negociaciones esta desacoplada de la clasificacion: Bitrix dispara `ONCRMLEADUPDATE`, Kestra consulta el lead actualizado y, si esta en `RESULTADO GANADO`, crea o reutiliza una negociacion en `VENTAS` (`CATEGORY_ID=1`, etapa `C1:NEW`) sin importar si el motor comercial fue Bitrix o Kestra.
