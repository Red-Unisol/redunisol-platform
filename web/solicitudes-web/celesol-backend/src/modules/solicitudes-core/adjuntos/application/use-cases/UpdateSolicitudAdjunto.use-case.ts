import type { UpdateSolicitudAdjuntoInput } from "../dtos/UpdateSolicitudAdjunto.dto";
...
type UpdateSolicitudAdjuntoUseCaseDependencies = {
...
export class UpdateSolicitudAdjuntoUseCase {
  constructor(
    private readonly dependencies: UpdateSolicitudAdjuntoUseCaseDependencies,
  ) {}

  async execute(input: UpdateSolicitudAdjuntoInput): Promise<SolicitudAdjunto> {
